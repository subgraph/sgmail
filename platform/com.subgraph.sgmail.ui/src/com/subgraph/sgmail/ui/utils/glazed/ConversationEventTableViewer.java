...
package com.subgraph.sgmail.ui.utils.glazed;
...
public class ConversationEventTableViewer<E> implements ListEventListener<E> {
     ...
     * {@link com.subgraph.sgmail.ui.utils.glazed.ConversationEventTableViewer}.
     */
    ...
    /**
     * Get the source of this {@link com.subgraph.sgmail.ui.utils.glazed.ConversationEventTableViewer}.
     */
   ...
   /**
    ...
    /**
     * Releases the resources consumed by this {@link com.subgraph.sgmail.ui.utils.glazed.ConversationEventTableViewer} so that it
     * may eventually be garbage collected.
     *
     * <p>An {@link com.subgraph.sgmail.ui.utils.glazed.ConversationEventTableViewer} will be garbage collected without a call to
     * {@link #dispose()}, but not before its source {@link ca.odell.glazedlists.EventList} is garbage
     * collected. By calling {@link #dispose()}, you allow the {@link com.subgraph.sgmail.ui.utils.glazed.ConversationEventTableViewer}
     * to be garbage collected before its source {@link ca.odell.glazedlists.EventList}. This is
     * necessary for situations where an {@link com.subgraph.sgmail.ui.utils.glazed.ConversationEventTableViewer} is short-lived but
     * its source {@link ca.odell.glazedlists.EventList} is long-lived.
     *
     * <p><strong><font color="#FF0000">Warning:</font></strong> It is an error
     * to call any method on a {@link com.subgraph.sgmail.ui.utils.glazed.ConversationEventTableViewer} after it has been disposed.
     */
    public void dispose() {
