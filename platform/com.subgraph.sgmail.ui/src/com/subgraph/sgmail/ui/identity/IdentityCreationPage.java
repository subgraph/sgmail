...
public class IdentityCreationPage extends WizardPage {
    ...
    public IdentityCreationPage(IdentityManager identityManager, AccountDetailsPage accountDetails, IdentityPublicationPage publicationPage) {
		super("identity");
    ...
    private void runKeyGeneration() {
    	ListenableFuture<PrivateIdentity> generationFuture = 
    			identityManager.createKeyGenerator()
    			.emailAddress(accountDetailsPage.getUsername() + "@" + accountDetailsPage.getDomain())
    			.realName(accountDetailsPage.getRealname())
    			.generate();
